...
//TODO: make a copy of this file that takes rotations instead of degrees that we can use in the meantime.
public class AutoTurn extends CommandBase {
    ...
    //Class Constructor
    public AutoTurn(ChassisSubsystem subsystem, double degrees, double speed){
        m_drive = subsystem;
        m_degrees = degrees;
        m_speed = speed;
